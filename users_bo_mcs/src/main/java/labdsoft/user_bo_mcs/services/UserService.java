...
public interface UserService {
    ...
    Boolean addParkiesToUsers(ParkyTransactionRequest request, Long customerManagerId) throws Exception;

    ParkyWalletDTO getParkyWalletOfUser(Long UserId) throws Exception;
